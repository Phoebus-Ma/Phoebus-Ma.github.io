...
**Installed Programs:** fluxbox, fbsetbg, fbsetroot, fluxbox-generate_menu, startfluxbox, fbrun, fluxbox-remote, 和 fluxbox-update_configs

**Installed Libraries:** None

**Installed Directories:** /usr/share/fluxbox 和 ~/.fluxbox
...
**Installed Programs:** icehelp, icesh, icesound, icewm, icewm-menu-fdo, icewm-menu-xrandr, icewm-session, icewm-set-gnomewm, icewmbg, 和 icewmhint

**Installed Libraries:** None

**Installed Directories:** /usr/share/doc/icewm-3.3.1, /usr/share/icewm 和 ~/.icewm
...
**Installed Programs:** gdm-control, gnome-panel-control, obxprop, openbox, openbox-gnome-session, openbox-kde-session 和 openbox-session

**Installed Libraries:** libobrender.so 和 libobt.so

**Installed Directories:** /etc/xdg/openbox, /usr/include/openbox, /usr/share/doc/openbox-3.6.1 和 /usr/share/themes.
...
**Installed Programs:** sawfish, sawfish-about, sawfish-client, sawfish-config, sawfish-kde4-session, sawfish-kde5-session, sawfish-lumina-session, sawfish-mate-session, 和 sawfish-xfce-session

**Installed Libraries:** 在/usr/lib/sawfish tree下的几个内部模块。

**Installed Directory:** /usr/include/sawfish, /usr/lib/sawfish, /usr/lib/rep/sawfish, 和 /usr/share/sawfish
