...
**Installed Programs:** 有太多的plasma程序(在/opt/kf5/bin中有63个)，无法在这里单独列出。

**Installed Libraries:** 有太多的plasma库(在/opt/kf5/lib中有40个)，无法在这里单独列出。

**Installed Directories:** 有太多的plasma目录(在/opt/kf5中超过1000个)，无法在这里单独列出。
